...
console.log('JoliCoin Service native interface vs. JoliCoin JSON RPC interface');
console.log('----------------------------------------------------------------------');
...
var bitcoind = require('../').services.Bitcoin({
  node: {
    datadir: process.env.HOME + '/.jolicoin',
    network: {
      name: 'testnet'
    }
  }
...
bitcoind.start(function(err) {
  ...
  console.log('JoliCoin started');
});

bitcoind.on('ready', function() {

  console.log('JoliCoin ready');
