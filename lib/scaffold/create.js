...
var BASE_PACKAGE = {
  description: 'A full JoliCoin node build with Bitcore',
  repository: 'https://github.com/dalijolijo/bitcore-node-joli',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-joli': 'dalijolijo/bitcore-lib-joli',
    'bitcore-node-joli': 'dalijolijo/bitcore-node-joli'
  }
};
